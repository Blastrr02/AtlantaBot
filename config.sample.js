module.exports = {
	...
	dashboard: {
		...
		baseURL: "https://dashboard.acerbot.xyz", // The base URl of the dashboard
		logs: "784424664377327657", // The channel ID of logs
		port: 8080, // Dashboard port
		expressSessionPassword: "XXXXXXXXXXX", // Express session password (it can be what you want)
		failureURL: "https://acerbot.xyz" // url on which users will be redirected if they click the cancel button (discord authentication)
	},
